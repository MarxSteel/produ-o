   ...
   <div class="container">
    <section class="content">
     ...
     <div class="col-xs-12"> 
      ...
      <form name="lacc" id="name" method="post" action="" enctype="multipart/form-data">
       <div class="col-xs-12"><br />
        <input name="lacc" type="submit" class="btn bg-orange btn-lg btn-block" id="lacc" value="LIBERAR EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["lacc"])
        {
         ...
         $executa = $PDO->query("UPDATE cadastro_acesso SET Status='3', UserLibera='$NomeUserLogado', DataLibera='$DataHoje' WHERE NumSerie='$NumeroREP' ");
         if($executa)
         {
