   ...
   <div class="container">
    <section class="content">
     ...
     <div class="col-xs-12"> 
      ...
      <form name="dacc" id="name" method="post" action="" enctype="multipart/form-data">
       <div class="col-xs-12">Observações
        <textarea name="descricao" cols="45" rows="3" class="form-control" id="descricao"></textarea>
       </div>
       <div class="col-xs-12"><br />
        <input name="dacc" type="submit" class="btn btn-danger btn-lg btn-block" id="dacc" value="DEVOLVER EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["dacc"])
        {
         ...
         $executa = $PDO->query("UPDATE cadastro_acesso SET Status='1', UserLibera='$NomeUserLogado', DataRetorna='$DataHoje', Observa='$Atual' WHERE NumSerie='$NumeroREP' ");
         if($executa)
         {
