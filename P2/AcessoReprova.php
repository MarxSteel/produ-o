   ...
   <div class="container">
    <section class="content">
     ...
     <div class="col-xs-12"> 
      ...
      <form name="racc" id="name" method="post" action="" enctype="multipart/form-data">
       ...
       <div class="col-xs-12"><br />
        <input name="racc" type="submit" class="btn btn-danger btn-lg btn-block" id="racc" value="REPROVAR EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["racc"])
        {
         ...
         $executa = $PDO->query("UPDATE cadastro_acesso SET Status='2', UserLibera='$NomeUserLogado', DataRetorna='$DataHoje', Observa='$Atual' WHERE NumSerie='$NumeroREP' ");
         if($executa)
         {
