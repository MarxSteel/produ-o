   ...
   <div class="container">
    <section class="content">
     ...
     <div class="col-xs-12"> 
      ...
      <form name="lib1510" id="name" method="post" action="" enctype="multipart/form-data">
       <div class="col-xs-12"><br />
        <input name="lib1510" type="submit" class="btn bg-orange btn-lg btn-block" id="lib1510" value="LIBERAR EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["lib1510"])
