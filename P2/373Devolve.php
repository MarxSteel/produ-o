     ...
     <div class="col-xs-12"> 
      ...
      <form name="d373" id="name" method="post" action="" enctype="multipart/form-data">
       ...
       <div class="col-xs-12"><br />
        <input name="d373" type="submit" class="btn btn-danger btn-lg btn-block" id="d373" value="DEVOLVER EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["d373"])
        {
         ...
         $executa = $PDO->query("UPDATE cadastro_373 SET Status='1', UserLibera='$NomeUserLogado', DataRetorna='$DataHoje', Observa='$Atual' WHERE NumSerie='$NumeroREP' ");
         if($executa)
         {
