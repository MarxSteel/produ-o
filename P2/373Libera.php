   ...
   <div class="container">
    <section class="content">
     ...
     <div class="col-xs-12"> 
      ...
      <form name="l373" id="name" method="post" action="" enctype="multipart/form-data">
       <div class="col-xs-12"><br />
        <input name="l373" type="submit" class="btn bg-orange btn-lg btn-block" id="l373" value="LIBERAR EQUIPAMENTO"  />
       </div>
      </form>
       <?php 
        if(@$_POST["l373"])
